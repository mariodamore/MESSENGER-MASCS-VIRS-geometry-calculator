...
PROFILE = default
PROJECT_NAME = messenger-mercury-surface-cassification-unsupervised_dlr
...
## install the package from setup.py via setuptools 
install_package :
	pip install .

## install the package from setup.py as editable
install_develop : 
